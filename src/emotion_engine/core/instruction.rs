...
impl Instruction {
    pub fn definitions(&self) -> impl Iterator<Item = Register> {
        (match self {
            ...
            Instruction::Sll(a, _, _) => [Some(*a), None, None],
            Instruction::Srl(a, _, _) => [Some(*a), None, None],
            Instruction::Sra(a, _, _) => [Some(*a), None, None],
            Instruction::Sllv(a, _, _) => [Some(*a), None, None],
            Instruction::Srlv(a, _, _) => [Some(*a), None, None],
            Instruction::Srav(a, _, _) => [Some(*a), None, None],
            Instruction::Jr(_) => [None, None, None],
            Instruction::Jalr(a, _) => [Some(*a), None, None],
            Instruction::Movz(a, _, _) => [Some(*a), None, None],
            Instruction::Movn(a, _, _) => [Some(*a), None, None],
            Instruction::Syscall => [None, None, None],
            Instruction::Break => [None, None, None],
            Instruction::Sync => [None, None, None],
            Instruction::Mfhi(a) => [Some(*a), None, None],
            Instruction::Mthi(_) => [None, None, None],
            Instruction::Mflo(a) => [Some(*a), None, None],
            Instruction::Mtlo(_) => [None, None, None],
            Instruction::Dsllv(a, _, _) => [Some(*a), None, None],
            Instruction::Dsrav(a, _, _) => [Some(*a), None, None],
            Instruction::Dsrlv(a, _, _) => [Some(*a), None, None],
            Instruction::Mult(a, _, _) => [Some(*a), Some(Register::Lo), Some(Register::Hi)],
            Instruction::Multu(a, _, _) => [Some(*a), Some(Register::Lo), Some(Register::Hi)],
            Instruction::Div(_, _) => [Some(Register::Lo), Some(Register::Hi), None],
            Instruction::Divu(_, _) => [Some(Register::Lo), Some(Register::Hi), None],
            Instruction::Add(a, _, _) => [Some(*a), None, None],
            Instruction::Addu(a, _, _) => [Some(*a), None, None],
            Instruction::Sub(a, _, _) => [Some(*a), None, None],
            Instruction::Subu(a, _, _) => [Some(*a), None, None],
            Instruction::And(a, _, _) => [Some(*a), None, None],
            Instruction::Or(a, _, _) => [Some(*a), None, None],
            Instruction::Xor(a, _, _) => [Some(*a), None, None],
            Instruction::Nor(a, _, _) => [Some(*a), None, None],
            Instruction::Mfsa(a) => [Some(*a), None, None],
            Instruction::Mtsa(_) => [None, None, None],
            Instruction::Slt(a, _, _) => [Some(*a), None, None],
            Instruction::Sltu(a, _, _) => [Some(*a), None, None],
            Instruction::Dadd(a, _, _) => [Some(*a), None, None],
            Instruction::Daddu(a, _, _) => [Some(*a), None, None],
            Instruction::Dsub(a, _, _) => [Some(*a), None, None],
            Instruction::Dsubu(a, _, _) => [Some(*a), None, None],
            ...
            Instruction::Dsll(a, _, _) => [Some(*a), None, None],
            Instruction::Dsrl(a, _, _) => [Some(*a), None, None],
            Instruction::Dsra(a, _, _) => [Some(*a), None, None],
            Instruction::Dsll32(a, _, _) => [Some(*a), None, None],
            Instruction::Dsrl32(a, _, _) => [Some(*a), None, None],
            Instruction::Dsra32(a, _, _) => [Some(*a), None, None],
            Instruction::Bgez(_, _) => [None, None, None],
            Instruction::J(_) => [None, None, None],
            Instruction::Jal(_) => [Some(Register::Ra), None, None],
            Instruction::Beq(_, _, _) => [None, None, None],
            Instruction::Bne(_, _, _) => [None, None, None],
            Instruction::Addiu(a, _, _) => [Some(*a), None, None],
            Instruction::Andi(a, _, _) => [Some(*a), None, None],
            Instruction::Ori(a, _, _) => [Some(*a), None, None],
            Instruction::Lui(a, _) => [Some(*a), None, None],
            Instruction::Ei => [None, None, None],
            Instruction::Sq(_, _, _) => [None, None, None],
            Instruction::Lh(a, _, _) => [Some(*a), None, None],
            Instruction::Lw(a, _, _) => [Some(*a), None, None],
            Instruction::Lbu(a, _, _) => [Some(*a), None, None],
            Instruction::Lhu(a, _, _) => [Some(*a), None, None],
            Instruction::Lwr(a, _, _) => [Some(*a), None, None],
            Instruction::Sb(_, _, _) => [None, None, None],
            Instruction::Sh(_, _, _) => [None, None, None],
            Instruction::Sw(_, _, _) => [None, None, None],
            Instruction::Ld(a, _, _) => [Some(*a), None, None],
    ...
    pub fn uses(&self) -> impl Iterator<Item = Register> {
        (match self {
            ...
            Instruction::Mult(_, b, c) => [Some(*b), Some(*c)],
            Instruction::Multu(_, b, c) => [Some(*b), Some(*c)],
            ...
            Instruction::Lhu(_, b, _) => [Some(*b), None],
            Instruction::Lwr(a, b, _) => [Some(*a), Some(*b)],
