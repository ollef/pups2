...
impl Display for Instruction {
    fn fmt(&self, f: &mut Formatter) -> std::fmt::Result {
        match self {
            ...
            Instruction::Bltz(rs, imm16) => write!(f, "bltz {rs}, {imm16}"),
            Instruction::Bgez(rs, imm16) => write!(f, "bgez {rs}, {imm16}"),
            Instruction::J(imm26) => write!(f, "j {imm26}"),
            Instruction::Jal(imm26) => write!(f, "jal {imm26}"),
            Instruction::Beq(rs, rt, imm16) => write!(f, "beq {rs}, {rt}, {imm16}"),
            Instruction::Bne(rs, rt, imm16) => write!(f, "bne {rs}, {rt}, {imm16}"),
            Instruction::Blez(rs, imm16) => write!(f, "blez {rs}, {imm16}"),
            ...
            Instruction::Lui(rt, imm16) => write!(f, "{rt} = lui {imm16}"),
            ...
            Instruction::Beql(rs, rt, imm16) => write!(f, "beql {rs}, {rt}, {imm16}"),
            Instruction::Bnel(rs, rt, imm16) => write!(f, "bnel {rs}, {rt}, {imm16}"),
