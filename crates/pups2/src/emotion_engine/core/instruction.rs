...
impl Instruction {
    pub fn definitions(&self) -> impl Iterator<Item = AnyRegister> {
        ...
        (match self {
            ...
            Instruction::Mthi(_) => [gpr(Register::Hi), None, None],
            Instruction::Mflo(a) => [gpr(*a), None, None],
            Instruction::Mtlo(_) => [gpr(Register::Lo), None, None],
    ...
    pub fn uses(&self) -> impl Iterator<Item = AnyRegister> {
        ...
        (match self {
            ...
            Instruction::Mfhi(_) => [gpr(Register::Hi), None],
            Instruction::Mthi(a) => [gpr(*a), None],
            Instruction::Mflo(_) => [gpr(Register::Lo), None],
...
impl Display for Instruction {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match self {
            ...
            Instruction::Mult1(a, b, c) => write!(f, "mult1 {a}, {b}, {c}"),
